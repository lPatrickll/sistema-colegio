...
export default function AdminHomePage() {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-2 text-slate-900">Panel de administrador</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Link
          ...
          className="border bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition block"
        >
          <h2 className="font-semibold mb-1 text-slate-900">Lista de profesores</h2>
          <p className="text-sm text-slate-600">
        ...
        <Link
          ...
          className="border bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition block"
        >
          <h2 className="font-semibold mb-1 text-slate-900">Lista de estudiantes</h2>
          <p className="text-sm text-slate-600">
